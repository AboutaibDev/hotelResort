...
export default function ContactPage() {
  ...
  const [ticketType, setTicketType] = useState("reservation");
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-slate-800 mt-1">
                    Avenue Mohammed V, Agdal, Rabat 10080, Morocco
                  </p>
                </div>
              </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-200/80 shadow-sm flex flex-col gap-6 lg:col-span-2">
            ...
            {isAuthenticated ? (
              ...
              <div className="flex items-center gap-2 text-xs text-amber-600 bg-amber-50 px-4 py-2.5 rounded-xl border border-amber-500/20">
                <AlertCircle className="h-4 w-4" />
                <span>Sign in to save this message as a tracked ticket in your dashboard.</span>
              </div>
            )}
            ...
            {success ? (
              <div className="p-8 text-center bg-emerald-50 border border-emerald-500/20 rounded-2xl flex flex-col items-center gap-4">
                ...
                <p className="text-sm text-slate-600">
                  {isAuthenticated
                    ...
                    : "Your message was sent successfully. We will follow up shortly."}
                </p>
                <button
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                ...
                {isAuthenticated && (
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-bold uppercase tracking-wider text-slate-500">Ticket Type</label>
                    <select
                      value={ticketType}
                    ...
                    >
                      ...
                      <option value="reservation">Reservation & Activities</option>
                      <option value="billing">Billing & Urgent Issues</option>
                    </select>
                  </div>
                )}
