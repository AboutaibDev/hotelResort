...
export default function ActivityReviews({ activityId, initialReviews, canReview }: ActivityReviewsProps) {
    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-6">
        {initialReviews.length === 0 ? (
          <p className="text-slate-500 text-sm italic">No reviews yet for this activity. Be the first to review!</p>
        ) : (
        ...
        canReview ? (
          ...
          >
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                ...
                placeholder="Tell other guests about the guides, difficulty level, location, or quality..."
          ...
          <div className="p-6 bg-amber-500/10 text-center rounded-2xl border border-amber-500/20 text-amber-800">
            <p className="text-sm font-medium">
              You must complete a confirmed booking for this activity before you can leave a review.
            </p>
          </div>
        )
      ) : (
